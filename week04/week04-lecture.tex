...
We can, however, do this much faster using sklearn's cosine\_similarity.
...
\begin{frame}{Considering Cosine Similarity}
	\begin{block}{Things to consider}
		...
		\item <2->What is the meaning of n-grams, stems, entities, stopwords when considering your RQ? How you should preproces, depends on your RQ and aim. 
...
\begin{frame}{Applications of cosine and soft cosine similarity}
	Applications of \emph{cosine} and \emph{soft cosine} in the field of Communication Science
