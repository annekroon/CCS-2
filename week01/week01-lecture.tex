...
\begin{frame}[fragile]{Molly Malone}
	...
	\begin{lstlistingoutput}
		[('In', 1), ("Dublin's", 1), ('fair', 1), ('city,', 1), ('where', 1), ('the', 1), ('girls', 1), ('are', 1), ('so', 1), ('pretty,', 1), ('I', 1), ('first', 1), ('set', 1)]
	\end{lstlistingoutput}

% let's create a list with the 13 most common words in this sentence. We can see that the most common words are also the most meaningless words, namely: stopwords. Let's clean up our data and remove the stopwords so that there are only meaningful words left!
\end{frame}
...
\begin{frame}[fragile]{Molly Malone}
	...
	\begin{lstlisting}
		...
		print(Counter(nostopwords.split()).most_common(13))
	...
	% let's do it again! Now we see that words that are once spelled with a capital letter and once without are counted as seperate words. To solve this, we can make all the letters lower letters.
