...
\textsc{\ding{52} Make sure your computer is ready to use for the course (see "study materials" on Canvas).}\\
\textsc{\ding{52} Read in advance: \cite{hirschberg_manning}.} \\
...
\textsc{\ding{52} Read in advance \cite{jordan_machine_2015}.}\\
