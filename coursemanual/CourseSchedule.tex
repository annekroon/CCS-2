...
\textsc{\ding{52}Read chapter 10: Text as data \cite{van2021computational}.} \\
\textsc{\ding{52}Read the article \cite{Boumans2016}.} \\
...
\textsc{\ding{52}Read chapter 11: Automatic analysis of text \cite{van2021computational}.} \\
\textsc{\ding{52}Read the article \cite{Brinberg2021}.} \\
=======
...
\textsc{\ding{52} Read the article \cite{Moller2018}.}\\
\textsc{\ding{52} Read the article \cite{Loecherbach2020}.}\\
